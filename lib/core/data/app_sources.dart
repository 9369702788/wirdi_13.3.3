...
class AppSources {
  ...
  // Some datasets use jsDelivr's GitHub mirror instead of the raw
  // GitHub host, since the latter can be ISP-throttled/blocked.
  ...
  static const String azkarJsonUrl =
      'https://cdn.jsdelivr.net/gh/YousefAsalya/Islamic-Pro-azkar-API@main/data/ar.json';
  ...
  static const String tafsirJsonUrl =
      'https://cdn.jsdelivr.net/gh/00AhmedMokhtar00/QuranTafseer-ar-json@master/tafseer.json';
  ...
  static const String transliterationJsonUrl =
      'https://cdn.jsdelivr.net/gh/risan/quran-json@main/dist/quran_transliteration.json';
