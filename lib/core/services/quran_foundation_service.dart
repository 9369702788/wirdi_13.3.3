...
class QuranFoundationService {
  ...
  static final Map<int, Map<int, List<QfWord>>> _memoryCache = {};

  /// Returns ayah-number -> words for [surahNumber], keyed by each
  /// verse's own verse_key (e.g. "86:3" -> ayah 3), not array position.
  static Future<Map<int, List<QfWord>>?> fetchWordsForSurah({
